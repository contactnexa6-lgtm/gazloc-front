    ...
    <div className="flex min-h-screen flex-col bg-[#0B0F19] text-white font-sans antialiased">
      ...
      <nav className="flex items-center justify-between px-12 py-6 bg-[#0B0F19] border-b border-gray-800">
        ...
        <div className="flex items-center gap-8">
          ...
          <a href="#" className="text-sm font-medium text-white border-b-2 border-[#FF5722] pb-1 font-semibold">Connexion </a>
        </div>
      </nav>

      {/* CONTENU DIVISÉ (ÉCRAN SCINDÉ) */}
          ...
          <div className="max-w-md mx-auto lg:mx-0">
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-start gap-4">
                <div className="p-2.5 rounded-lg bg-gray-800/60 border border-gray-700 text-[#FF5722] text-sm flex items-center justify-center h-10 w-10">📍</div>
                <div>
                  <h4 className="text-sm font-bold">Dépôts localisés</h4>
                  <p className="text-xs text-gray-400 mt-0.5">Trouvez le point de vente le plus proche de chez vous.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="p-2.5 rounded-lg bg-gray-800/60 border border-gray-700 text-[#FF5722] text-sm flex items-center justify-center h-10 w-10">📊</div>
                <div>
                  <h4 className="text-sm font-bold">Stock en temps réel</h4>
                  <p className="text-xs text-gray-400 mt-0.5">Voyez la disponibilité exacte avant de commander.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="p-2.5 rounded-lg bg-gray-800/60 border border-gray-700 text-[#FF5722] text-sm flex items-center justify-center h-10 w-10">💵</div>
                <div>
                  <h4 className="text-sm font-bold">Paiement à la livraison</h4>
                  <p className="text-xs text-gray-400 mt-0.5">Réglez en espèces à la réception, sans paiement en ligne.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[480px] bg-white text-gray-900 flex flex-col justify-center px-8 lg:px-16 py-16 shadow-2xl">
          <div className="w-full max-w-sm mx-auto space-y-6">
            <div>
              ...
              <h2 className="text-3xl font-black text-gray-950 tracking-tight">Connexion</h2>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full rounded-md bg-[#FF5722] py-3 text-sm font-bold text-white hover:bg-[#e04e1f] transition-colors shadow-md shadow-[#FF5722]/10 mt-2">
                Se connecter
              </button>
            </form>
            ...
            <p className="text-center text-xs text-gray-500">
              Nouveau sur la plateforme ? <a href="#" className="font-bold text-[#FF5722] hover:underline">Créer un compte</a>
            </p>
          </div>
        </div>
